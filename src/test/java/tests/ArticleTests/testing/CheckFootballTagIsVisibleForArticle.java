...
public class CheckFootballTagIsVisibleForArticle extends BaseTest {
    ...
    @Test(description = "WN-6 Check 'Football' tag visible for created article in Analysis page")
    public void checkFootballTagIsVisibleForArticle() {
