...
public class CheckInsertLinkCurrentWindow extends BaseTest {
    ...
    @Test(description = "WN-99 : Check Article-Content-Insert-Link-Current-Window (WAF-302) ")
    public void checkLinkOpensInCurrentWindow() {
